# Build-Club
Hello everyone! This is the new GitHub repository, which will include links to various projects, manuals, and online resources. We hope you enjoy your journey on fostering knowledge, creativity, collaboration and resourcefulness.  

This Repo is currently an early work in progress. But for now, we'll just check if everything in this readme file works by adding these links to various resources in no particular order. In case of feedback, please send a pull request or raise an issue so we can keep making this site an amazing knowledge hub for all!
...
This roadmap above contains an exhaustive list of subtopics that people can explore related to embedded systems
  
- MATLAB-Simulink Challenge Project Hub in GitHub: https://github.com/mathworks/MATLAB-Simulink-Challenge-Project-Hub

It is a GitHub maintained by the people behind MATLAB, featuring a wide range of industry- and research-oriented projects across disciplines for more advanced users to build/test/develop/solve. Please read through the instructions and be prepared before proceeding.
...
- Digikey web tools: https://www.digikey.in/en
  Access these tools by visiting the website, hovering over the "resources" tab, and choosing which one of the many web tools you need to use.
...
- HackMakeMod: https://youtube.com/@hackmakemod?si=4ryUx8HAqGWATcwi
- Adafruit: https://youtube.com/@adafruit?si=HadPToTAkt0oF1tT
- DigiKey: https://www.youtube.com/@digikey
- EEVBlog: https://youtube.com/@eevblog?si=6iwDbXPxjNOyVusW
...
- Ben Eater: https://youtube.com/@beneater?si=tZHWRnMnAC7lSHce
- Circuit Digest: https://youtube.com/@circuitdigest?si=LQi9UWxppDmI-Kcp
...
- PACE Soldering Tutorials (YT): https://youtube.com/playlist?list=PL926EC0F1F93C1837&si=TGTzb4Q2lrccIQPU
...
Mixed Domain Project Designs/Inspirations (Varied Difficulty/Just for Fun):
...
Resources:
  ...
  - University of Michigan, USA - Control Systems Tutorials with MATLAB/Simulink: https://ctms.engin.umich.edu/CTMS/index.php?aux=Home
  ...
  - Control Theory Subreddit Wiki - https://www.reddit.com/r/ControlTheory/wiki/index/
  ...
  - Pratik Phadte -  How does PID controller work? | Simple Explanation on Quadcopter  (YT): https://youtu.be/dMRDzicSvXk?si=fOwuq2VORMKdmIlE
...
- Altium Education - Free PCB Design Courses (Must have an Altium Student License!): https://education.altium.com/
...
- Carl Bugeja (YT): https://youtube.com/@carlbugeja?si=ZvTY6cVx-qFKe3pA
- SIROJU (YT - Motor Contol and Design): https://youtube.com/@srj4555?si=WYE2EK_oNZkoEC7S
...
- FIRST Robotics Competition (YT): https://youtube.com/@firstroboticscompetition?si=ybQqWJwng-1IaSPJ
